...
@FeignClient(name = "cg-pay-provider", fallbackFactory = FeignClientFallbackFactory.class)
public interface UserFeignClient {
  ...
  @RequestMapping(value = "/findByCondition/{param}", method = RequestMethod.GET)
  public User findByCondition(@PathVariable("param") String param);
...
class FeignClientFallbackFactory implements FallbackFactory<UserFeignClient> {
  ...
  public UserFeignClient create(Throwable cause) {
	...
	@Override
	public User findByCondition(String param) {
		if(null== param) {
			return null;
		}
		return null;
